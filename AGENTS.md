...
This repo does not currently maintain a decision log; if you make a project-level decision, record it in `src/main/adoc/decision-log.adoc` (create if missing).
