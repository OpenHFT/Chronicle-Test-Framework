...
| If you must show a symbol that does not exist in ISO-8859-1, spell it out (for example `>=`, `:alpha:`, `:yes:`) rather than inserting Unicode outside Latin-1. | Extended encodings outside ISO-8859-1 are *not* portable and are therefore disallowed. |
