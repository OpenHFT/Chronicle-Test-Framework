...
class VanillaFlakyTestRunnerTest {
    ...
    void runZero() {
        ...
        assertDoesNotThrow(() ->
                FlakyTestRunner.builder(action)
                        ...
                        .build()
                        .run(),
                "0 iterations allows immediate success");
        assertEquals(0, action.countDown, "action not invoked when maxIterations=0");
    }
    ...
    void run() {
        ...
        assertDoesNotThrow(runner::run, "single attempt succeeds");
    }
    ...
    void runTry2() {
        ...
        assertDoesNotThrow(runner::run, "retry succeeds within max iterations");
    }
    ...
    void runTry3() {
        ...
        assertThrows(IllegalStateException.class, runner::run, "failure propagates after retries exhausted");
    }
    ...
    void testNoThrow() {
        ...
        assertDoesNotThrow((Executable) runner::runOrThrow, "runOrThrow does not throw on success");
    }
    ...
    void testUnchecked() {
        ...
        assertDoesNotThrow(runner::run, "unchecked runner does not throw on success");
    }
    ...
    void demo() {
        ...
        assertThrows(IllegalStateException.class, () ->
                FlakyTestRunner.builder(action)
                        ...
                        .build()
                        .run(),
                "exhausted runner rethrows the last failure");
        assertFalse(errors.isEmpty(), "error logger receives output");
    }
