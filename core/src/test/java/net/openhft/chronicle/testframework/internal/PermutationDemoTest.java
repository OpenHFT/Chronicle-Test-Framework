...
final class PermutationDemoTest {
    ...
    void print() {
        assertEquals(6,
                Permutation.of("A", "B", "C")
                        ...
                        .count(),
                "permutation count for 3 elements");
    }
    ...
    Stream<DynamicTest> demo() {
        ...
        assertEquals(6, Permutation.of(setA, setB, setC).count(), "setter permutations count");
        ...
        return DynamicTest.stream(Permutation.of(setA, setB, setC),
                ...
                operations -> {
                    ...
                    assertEquals(expected, actual, "setter order yields identical bean state");
                });
    }
