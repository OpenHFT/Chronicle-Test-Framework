    ...
    Stream<DynamicTest> demo() {
        ...
        return DynamicTest.stream(Combination.<Consumer<FaultTolerantBitSet>>of(
                ...
                operations -> {
                    ...
                    assertTrue(bitSet.isValid(), "bit set remains valid");
                });
    }
