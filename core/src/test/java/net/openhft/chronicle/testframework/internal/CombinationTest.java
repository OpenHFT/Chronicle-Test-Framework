...
final class CombinationTest {
    ...
    void testOfEmpty() {
        ...
        assertEquals(expected, actual, "empty input yields only the empty set");
    }
    ...
    void testOfSingleton() {
        ...
        assertEquals(
                ...
                actual,
                "singleton input yields empty + singleton"
        );
    }
    ...
    void testOfTwo() {
        ...
        assertEquals(expected, actual, "2-element input yields 4 combinations");
    }
    ...
    void testOfThree() {
        ...
        assertEquals(expected, actual, "3-element input yields 8 combinations");
    }
    ...
    void testOfTwoList() {
        ...
        assertEquals(expected, actual, "list input yields expected combinations");
    }
    ...
    void testOfStream() {
        ...
        assertEquals(expected, actual, "stream input yields expected combinations");
    }
}
