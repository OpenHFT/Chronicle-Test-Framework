...
class DtoTesterDemoTest {
    ...
    void demo() {
        ...
        assertDoesNotThrow(() -> DtoTester.builder(MyDto.class, MyDtoImpl::new)
                ...
                // Assert the validation rules when all mandatory mutators have been invoked and with a combination of optional ones
