...
final class ProductTest {
    ...
    void product2() {
        ...
        assertEquals(expected, actual, "product2 yields expected cartesian product");
    }
    @Test
    void product2Stream() {
        final List<String> strings = Arrays.asList("A", "B", "C");
        ...
        assertEquals(expected, actual, "product2(streams) yields expected cartesian product");
    }
    ...
    void product3() {
        ...
        assertEquals(expected, actual, "product3 yields expected cartesian product");
    }
    ...
    void product3Stream() {
        ...
        assertEquals(expected, actual, "product3(streams) yields expected cartesian product");
    }
}
